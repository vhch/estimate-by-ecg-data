...
class EnhancedCnntobert2(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(512 + 2 + 128, 256)
...
class Cnntobert2(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(256 + 2 + 64, 64)
...
class EnhancedCNNGRUAgePredictor2(nn.Module):
    def __init__(self):
        ...
        # LSTM layer
        self.gru = nn.GRU(input_size=512, hidden_size=256, num_layers=2, batch_first=True, dropout=0.5)
...
class EnhancedCNNGRUAgePredictor4(nn.Module):
    def __init__(self):
        super().__init__()
